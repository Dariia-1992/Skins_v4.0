...
public class SkinsRepository {
    ...
    private static void initItems() {
        ...
        addItem("Text Title here post 1",
                new int[]{
                        R.drawable.item_1_1,
                        R.drawable.item_1_2,
                        R.drawable.item_1_3},
    ...
    private static void addItem(String title, int [] bigImage, int rating, int description, String url, int [] descriptionImages, boolean isFavorite) {
        items.add(new Skin(UUID.randomUUID().toString(), title, bigImage, rating, description, url, descriptionImages, isFavorite));
    }
}
